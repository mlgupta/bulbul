...
public class SaveAsJPEGTiles {
    ...
    public static void main(String [] args) throws Exception {
        ...
        String in = "D:\\Sudheer\\Bulbul\\SVG Programing\\DesignEngine\\DesignEngine\\Results\\SampleSVG\\slidetool.svg";
        int documentWidth = 450;
        int documentHeight = 500;
        int dw2 = documentWidth / 2;
        int dh2 = documentHeight / 2;
        p.tile(in, "D:\\Sudheer\\Bulbul\\SVG Programing\\DesignEngine\\DesignEngine\\Results\\tileTopLeft.jpg", new Rectangle(0, 0, dw2, dh2));
        p.tile(in, "D:\\Sudheer\\Bulbul\\SVG Programing\\DesignEngine\\DesignEngine\\Results\\tileTopRight.jpg", new Rectangle(dw2, 0, dw2, dh2));
        p.tile(in, "D:\\Sudheer\\Bulbul\\SVG Programing\\DesignEngine\\DesignEngine\\Results\\tileBottomLeft.jpg", new Rectangle(0, dh2, dw2, dh2));
        p.tile(in, "D:\\Sudheer\\Bulbul\\SVG Programing\\DesignEngine\\DesignEngine\\Results\\tileBottomRight.jpg", new Rectangle(dw2, dh2, dw2, dh2));
        System.exit(0);
    }
}