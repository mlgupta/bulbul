...
public class SVGCircle extends SVGShape  {
   ...
   * @param studio
   */
  public SVGCircle(SVGApplet studio){
    super(studio);
    ids.put("id","circle");
    ...
    if(svgTab!=null && bounds!=null){
			...
			if(getStudio().getSvgSelection()!=null && document!=null){
				...
				if(parent!=null){
					...
					String colorString="grey";//getSVGEditor().getColorChooser().getColorString(svgTab, getSVGEditor().getSVGColorManager().getCurrentColor());
