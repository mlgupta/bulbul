...
public class SVGSelectionListener extends  MouseAdapter implements  MouseMotionListener,  KeyListener {
 ...
 /**
  ...
  public void mousePressed(MouseEvent evt){
    ...
    if(selection.isSelectionEnabled() && isPopupEvent){
      //shows a popup
      //selection.getStudio().getPopupManager().showPopup(frame, evt.getPoint());
    }
  }
    ...
    if(selection.isSelectionEnabled()){
      ...
      if(range!=null && evt.getModifiers()==0){
        ...
        if(evt.getKeyCode()==KeyEvent.VK_C){
          ...
          getSelectionManager().getSvgSelection().getStudio().getMainToolBar().getMtbOrder2Up().doClick();
        }else if(evt.getKeyCode()==KeyEvent.VK_DOWN){
          getSelectionManager().getSvgSelection().getStudio().getMainToolBar().getMtbOrder2Down().doClick();
        }
      }else if(evt.getModifiers()==KeyEvent.SHIFT_MASK ){
        if(evt.getKeyCode()==KeyEvent.VK_UP){
          getSelectionManager().getSvgSelection().getStudio().getMainToolBar().getMtbAlignTop().doClick();
        }else if(evt.getKeyCode()==KeyEvent.VK_DOWN){
          getSelectionManager().getSvgSelection().getStudio().getMainToolBar().getMtbAlignBottom().doClick();
        }else if(evt.getKeyCode()==KeyEvent.VK_LEFT){
          getSelectionManager().getSvgSelection().getStudio().getMainToolBar().getMtbAlignLeft().doClick();
        }else if(evt.getKeyCode()==KeyEvent.VK_RIGHT){
          getSelectionManager().getSvgSelection().getStudio().getMainToolBar().getMtbAlignRight().doClick();
        ...
        if(evt.getKeyCode()==KeyEvent.VK_UP){
          getSelectionManager().getSvgSelection().getStudio().getMainToolBar().getMtbOrder2Top().doClick();
        }else if(evt.getKeyCode()==KeyEvent.VK_DOWN){
          getSelectionManager().getSvgSelection().getStudio().getMainToolBar().getMtbOrder2Bottom().doClick();
        }
      }
    }  
  }
