...
public class SVGCanvas extends JSVGCanvas  {
 ...
 /**
   ...
   * @description 
   */
  public void init(SVGApplet studio, SVGScrollPane scrollPane){
    this.scrollPane=scrollPane;
        ...
        getStudio().getSvgTabManager().setCurrentSVGTab(((SVGTab)getStudio().getSvgTabSet().getSelectedComponent()).getName());  
      ...
      public void run() {
        synchronized(svgCanvas){isDisposing=true;}
