...
public class SVGToolkit  {
   ...
   * @description 
   */
  public SVGToolkit(SVGApplet studio) {
    this.studio=studio;
  }
   ...
   * @param svgTab
   */
  public Element getDefsElement(SVGTab svgTab){
    Element defs=null;
    if(svgTab!=null){
        ...
        if(document!=null){
          ...
          if(root!=null){
            ...
            if(defs==null && svgTab.getScrollPane().getSvgCanvas().getUpdateManager()!=null && 
                  svgTab.getScrollPane().getSvgCanvas().getUpdateManager().getUpdateRunnableQueue()!=null){
   ...
   * @param svgTab
   */
  public String getId(SVGTab svgTab, String baseString){
    if(svgTab!=null){
