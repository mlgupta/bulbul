...
public class SVGGroupUnGroup implements SVGClassObject  {
  ...
  private String labelgroupug="";
  private String labelgungroup="";
  private String undoredogroupug="";
  private String undoredogungroup="";
   ...
   * @description 
   */
  public SVGGroupUnGroup(SVGApplet studio){
  ...
  public Collection getPopupItems(){
		...
		SVGPopupItem item=new SVGPopupItem(getSVGEditor(), idgroupug, labelgroupug, "Group"){
		...
		item=new SVGPopupItem(getSVGEditor(), idgungroup, labelgungroup, "Ungroup"){
        ...
        parent=((Node)finalSelectedNodes.getFirst()).getParentNode();
          ...
          if(finalSelectedNodes.contains(current)){
            toBeGrouped.add(current);
				...
				String id=getStudio().getSvgToolkit().getId(svgTab, "");
