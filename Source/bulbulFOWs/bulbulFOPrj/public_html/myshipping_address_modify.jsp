...
<html>
<head>
<title><bean:message key="title.ShippingAddressModify" /></title>
...
<body>
<html:form action="myAddressBookModifyAction.do" >
<html:hidden property="hdnCustomerAddressBookTblPk" />
...
<html:hidden property="hdnIsCountryListed" />
  ...
  <table width="725px" border="0" align="center" cellpadding="0" cellspacing="0" id="panRevisiting">
    <tr>
      ...
      <td width="696px" background="images/myprntn_pan_tile17px.gif" class="heading_pan"><bean:message key="page.ShippingAddressModify" /> :</td>
        ...
        <table width="600px" border="0" align="center" cellpadding="2" cellspacing="1" class="bgColor_006600" style="margin-top:15px; margin-bottom:15px ">
          <tr bgcolor="#FFFFFF">
            <td width="6%" align="center" valign="bottom" class="th_0A8A09" >
              <bean:message key="tbl.ChangeAddressBelow" />
            </td>
          </tr>
          <tr bgcolor="#FFFFFF">
