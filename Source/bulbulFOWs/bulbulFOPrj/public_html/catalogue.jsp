...
<head>
<title><bean:message key="title.Catalogue" /></title>
        ...
        <tr>
          <td width="361px" valign="bottom">
            <table width="361px" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td width="163px"><div align="right"><a href="home.jsp"><img src="images/logo_catalogue.gif" alt="Home Icon" width="141px" height="62px" border="0"></a></div></td>
                <td width="30px">&nbsp;</td>
          ...
          <td width="409px" valign="bottom">
            <table width="409px" border="0" cellpadding="0" cellspacing="0">
              ...
              <td width="75px"><img src="images/tab_catalogue_active.gif" alt="Catalogue" width="73px" height="39px" border="0"></td>
  ...
  <tr>
    <td height="45px">
      ...
      <table width="100%" height="45px"  border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td width="47%" background="images/catalogue_tile_grad45px.gif">
              ...
              <tr>
                ...
                <td width="409px">
                  <table width="409px" height="45px" border="0" align="right" cellpadding="0" cellspacing="0">
                    <tr>
                      <td width="75px">&nbsp;</td>
                      <td width="75px" background="images/catalogue_tile_45px.gif">&nbsp;</td>
                      <td width="75px">&nbsp;</td>
                      <td width="84px">&nbsp;</td>
                      <td width="75px">&nbsp;</td>
                      <td width="25px">&nbsp;</td>
  ...
  <tr>
    <td>
      ...
      <table width="100%" height="100%" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
          <td>
            <iframe id="framCatalogue" name="framCatalogue" src="productListAction.do" width="100%" height="100%"  style="overflow:auto;position:relative; left:0px; top:0px;" frameborder="0">
            </iframe>
          </td>
        </tr>
      </table>
  ...
  <tr>
    <td height="14px">
      ...
      <table width="100%" height="14px" border="0" style="position:absolute; bottom:0;" cellpadding="0" cellspacing="0">
        <tr>
          <td background="images/catalogue_tile_14px.gif"><div align="center">Copy Right mesage Here</div></td>
        </tr>
      </table>
      <!-- Footer Table Ends -->
    </td>
