...
<html>
<head>
<title><bean:message key="title.TrackedOrderDeleted" /></title>
...
<body>
  ...
  <table width="725px" border="0" align="center" cellpadding="0" cellspacing="0" id="panTrackedDesign">
    <tr>
      ...
      <td width="696px" background="images/studio_pan_tile17px.gif" class="heading_pan"><bean:message key="lbl.TrackedOrderDeleted" /></td>
        ...
        <table width="100%"  border="0" cellpadding="1" cellspacing="1">
          <tr>
            <td height="200px" align="center">
              <bean:message key="info.TrackedOrderDeleted.Part1"/> <span class="text_CC6A00" ><bean:write name="orderGenDate" /> </span><bean:message key="info.TrackedOrderDeleted.Part2"/> <span class="text_CC6A00" ><bean:write name="orderCode" /></span> <bean:message key="info.TrackedOrderDeleted.Part3"/> <br><br>
              <bean:message key="info.TrackedOrderDeleted.Part4"/> <a class="linkMenu" href="trackB4Action.do?operation=order"> <bean:message key="link.Here"/></a>
            </td>
          </tr>          
        </table>
      </td>
