...
<html>
<head>
<title><bean:message key="title.PostPayment" /></title>
...
<bean:define id="isMultipleAddress" name="orderHeaderBean" property="isMultipleAddress" />
  ...
  <table width="725px" border="0" align="center" cellpadding="0" cellspacing="0" id="panRevisiting">
    <tr>
      ...
      <td width="696px" background="images/studio_pan_tile17px.gif" class="heading_pan"><bean:message key="page.PostPayment" /> :</td>
      <td width="5px"><img src="images/studio_pan_corner_rt.gif" width="5px" height="17px"></td>
    </tr>
	  <tr>
      <td height="20px" bgcolor="#FFFFFF" colspan="3" class="bdrLeftColor_CC6A00 bdrRightColor_CC6A00 bdrTopColor_CC6A00">
        ...
        <table width="600px"  border="0" align="center" cellpadding="2" cellspacing="1" class="bgColor_CC6A00" style="margin-top:15px; margin-bottom:15px">
          ...
          <tr bgcolor="#FFFFFF">
            <td colspan="4" align="center" height="30px">
              ...
              <html:button style="width:130px; height:20px;" property="btnLogOut" onclick="window.top.location='homeLogoutAction.do'" styleClass="buttons"><bean:message key="btn.Logout" /></html:button>
            </td>
          </tr>
        </table>
	  ...
	  <tr>
	    <td height="20px" bgcolor="#FFFFFF" colspan="3" class="bdrLeftColor_CC6A00 bdrRightColor_CC6A00">
        <!-- Info To Customer About Payment Made Table Starts -->
        <table width="600"  border="0" align="center" cellpadding="2" cellspacing="1" class="bgColor_CC6A00" style="margin-bottom:15px">
          <tr bgcolor="#FFFFFF">
            <td width="42%" align="right"><bean:message key="tbl.YourOrderCode" /> :</td>
            <td width="58%" class="text_008000"><bean:write name="orderHeaderBean" property="orderCode" /></td>
          </tr>
          <tr bgcolor="#FFFFFF">
            <td align="right"><bean:message key="tbl.YourPaymentChoice" /> : </td>
            <td class="text_008000"><bean:write name="paymentMode" /></td>
          </tr>
        </table>
        <!-- Info To Customer About Payment Made Table Ends -->
	    </td>
	  </tr>
	  <tr>
	    <td bgcolor="#FFFFFF" colspan="3" class="bdrLeftColor_CC6A00 bdrRightColor_CC6A00">
        <!-- Order Detail With Shipping Address  Table Starts -->
        <table width="600px" border="0" align="center" cellpadding="2" cellspacing="1" class="bgColor_CC6A00" style="margin-bottom:15px ">
          <tr bgcolor="#FFFFFF">
            <td width="44%" align="center" valign="bottom" class="th_F89627" ><bean:message key="tbl.ShippedTo" /> </td>
          ...
          <tr bgcolor="#FFFFFF">
            ...
            <td align="center"  rowspan="<%=rowSpanValue%>">
              <!-- Shipping Address 4 Order Item 1 Table Starts -->  
              ...
              <!-- Shipping Address 4 Order Item 1 Table Ends -->  
            </td>
            <%
              }
            %>
            <td align="center" valign="top">
              <!-- Order Item 1 Details Table Starts -->  
              <table width="100%"  border="0" cellspacing="1" cellpadding="1">
                <tr>
                  <td align="center" class="text_008000">
                    <bean:write name="orderDetail" property="designName" /> - <bean:write name="orderDetail" property="merchandiseName" />
                  </td>
                </tr>
                <tr>
                  <td align="center">
              ...
              <!-- Order Item 1 Details Table Ends -->  
            </td>
          </tr>
          </logic:iterate>          
        </table>
        <!-- Order Detail With Shipping Address  Table Ends -->
      </td>
    </tr>
    <tr>
