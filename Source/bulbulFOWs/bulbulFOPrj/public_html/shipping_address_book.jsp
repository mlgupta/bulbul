...
<script>
  function btnDelete_onclick(customerAddressBookTblPk){
    ...
    window.location='addressBookDeleteAction.do?customerAddressBookTblPk='+customerAddressBookTblPk;
  }
  function btnModify_onclick(customerAddressBookTblPk){
    window.location='addressBookModifyB4Action.do?customerAddressBookTblPk='+customerAddressBookTblPk;
  }  
  function btnShipHere_onclick(customerAddressBookTblPk){
    window.location='shippingAddressBookAction.do?customerAddressBookTblPk='+customerAddressBookTblPk;
  }  
</script>
</head>
<body>
  ...
  <table width="725px" border="0" align="center" cellpadding="0" cellspacing="0">
    <tr>
      ...
      <td width="696px" background="images/studio_pan_tile17px.gif" class="heading_pan"><bean:message key="page.ShippingAddressBook" /> :</td>
      <td width="5px"><img src="images/studio_pan_corner_rt.gif" width="5px" height="17px"></td>
    </tr>
    <tr>
      <td bgcolor="#FFFFFF" colspan="3" valign="top" height ="393px" class="bdrLeftColor_CC6A00 bdrTopColor_CC6A00 bdrRightColor_CC6A00">
            ...
            <logic:iterate id="address" name="addresses" indexId="gIndex" >
              ...
              %>
                  <td width="33%" align="center" valign="top">
                    ...
                    <table width="225px" height="185px" border=0 cellpadding=1 cellspacing=1 class="bdrColor_CC6A00 bgColor_FFEDDA">
                      <tr>
                      ...
                      <tr>
                        <td height="25px" align="center" valign="bottom"> 
                          <img src="images/btn_ship_here.gif" alt="Ship Here" title="Ship To This Address"  width="73px" height="16px" border="0" style="cursor:pointer; cursor:hand" onclick="return btnShipHere_onclick('<bean:write name="address" property="customerAddressBookTblPk" />');"> 
      ...
      <tr>
        <td bgcolor="#FFFFFF" colspan="3" class="bdrLeftColor_CC6A00  bdrRightColor_CC6A00">
          ...
          <table width="100%"    border="0" cellpadding="1" cellspacing="1">
            <tr>
              <td height="10px" width="33%" class="bdrTopColor_CC6A00">&nbsp;</td>
              <td align="center" width="33%" class="bdrTopColor_CC6A00">
                <html:button styleClass="buttons" style="width:60px; height:20px" property="btnNew" onclick="window.location.replace('addressBookNewB4Action.do');" title="Create New Address..."><bean:message key="btn.New" /></html:button>
                <html:button styleClass="buttons" style="width:60px; height:20px" property="btnCancel" onclick="window.location.replace('shipping_address.jsp');"><bean:message key="btn.Cancel" /></html:button>
              </td>
              <td align="right" width="33%" class="bdrTopColor_CC6A00">
                ...
                <%if((pageNumber==1 && pageNumber!=pageCount)){%>
                  <%for(int counter=startCounter; counter<endCounter; counter++){ %>
                      ...
                      <%}else{%>
                        <a class="linkPageNav" href="shippingAddressBookB4Action.do?pageNumber=<%=counter%>"><%=counter%></a>
                      <%}%>
                  <%}%>                      
                  <%if ((endCounter)<=pageCount){%>
                    <a class="linkPageNav" href="shippingAddressBookB4Action.do?pageNumber=<%=endCounter%>">Next(<%=endCounter%>)</a>
                  <%}%>                                           
                  <a class="linkPageNav" href="shippingAddressBookB4Action.do?pageNumber=<%=pageCount%>">Last(<%=pageCount%>)</a>
                <%}else if((pageNumber!=1 && pageNumber==pageCount)){%>
                  <a class="linkPageNav" href="shippingAddressBookB4Action.do?pageNumber=<%=1%>">First(1)</a>
                  <%if(!((startCounter-1)<=0)){%>
                    <a class="linkPageNav" href="shippingAddressBookB4Action.do?pageNumber=<%=startCounter-1%>">Prev(<%=startCounter-1%>)</a>
                  <%}%>
                  <%for(int counter=startCounter; counter<endCounter; counter++){ %>
                      <%if(counter==pageNumber){%>
                        <span class="linkPageNavCurrentPage"><%=counter%></span>
