...
<html:javascript  formName="paymentByDCForm" dynamicJavascript="true" staticJavascript="false" />
...
<body  style="margin:0px">
  <table bgcolor="#FFFFFF" width=100% height=100% align="center" border=0 cellspacing="1" cellpadding="1">
    <tr>
      <td colspan="2">
        <span class="text_008000"><bean:message key="info.PayByDebitCard" /></span>
      </td>
      <td width="49%" rowspan="7" align="center"><img src="images/debitcards_collage.gif" width="199px" height="67px"></td>
    </tr>
    <html:form action="paymentByDCAction.do" onsubmit="this.target='_parent'; return validatePaymentByDCForm(this);">
    <tr>
      <td width="24%" align="right"> <bean:message key="cbo.CardType" />:</td>
      <td width="27%">
        <html:select property="cboDCType"style="width:150px">
    ...
    <tr>
      ...
      <td>
        <html:text property="txtDCNumber" style="width:150px" onkeypress="return integerOnly(event)" maxlength="16" />
      </td>
    </tr>
    <tr>
      <td align="right"><bean:message key="txt.CVV/CVCCode" />:</td>
      <td>
        <html:text property="txtCVVCode4DC" style="width:150px" onkeypress="return integerOnly(event)" maxlength="3"/>
      </td>
    </tr>
    <tr>
      <td align="right"><bean:message key="dt.ExpireYear" /></td>
      <td>
        <html:select property="cboExpMonth4DC" style="width:73px">
        ...
        <html:select property="cboExpYear4DC" style="width:73px">
    ...
    <tr>
      ...
      <td>
        <html:text property="txtDCHolderName" style="width:150px" />
      </td>
    </tr>
    <tr>
      <td align="right">&nbsp;</td>
