...
<body>
<html:form action="addressBookNewAction.do">
...
<html:hidden property="hdnIsCountryListed" />
  ...
  <table width="725px" border="0" align="center" cellpadding="0" cellspacing="0" id="panRevisiting">
    <tr>
      ...
      <td width="696px" background="images/studio_pan_tile17px.gif" class="heading_pan"><bean:message key="page.ShippingAddressNew" /> :</td>
