...
function Calendar(calId,calWidth,calHeight){
  ...
  this.borderClassName='bdrColor_336666';
  this.bgClassName='bgColor_DFE7EC';
  this.textClassName='';
  this.boldClassName='';
...
function ShowCalendar(theDate){
  MM_findObj(this.calId + 'calendar').innerHTML="";
	...
	varCal ="<table border='0'  cellspacing='2' cellpadding='1' class='" + this.borderClassName + " " + this.bgClassName + "' width='"+ this.calWidth + "px' >";	

  //Timezone combo 
	if(!this.noTimezone){
    varCal += "<tr>";
    if (eval(this.timezoneDisabled)){
      varCal += "<td colspan='7' align='center' class='" + this.borderClassName + " " + this.boldClassName + "' >";
      varCal += this.selectedTimezoneName
      varCal += "<select id='"+ this.calId + "cboTZ' name='"+ this.calId + "cboTZ' style='display:none; width:"+ (this.calWidth-10) + "px' onchange='"+ this.calId + ".tzOnChange()' class='" + this.textClassName + " ' title='"+ this.tooltipTimezone +"' >";
      varCal += this.optionsTZ;
      varCal += "</select>";
      varCal += "</td>";
    }else{
      varCal += "<td colspan='7' align='center' class='" + this.borderClassName + "' >";
      varCal += "<select id='"+ this.calId + "cboTZ' name='"+ this.calId + "cboTZ' style='width:"+ (this.calWidth-10) + "px' onchange='"+ this.calId + ".tzOnChange()' class='" + this.textClassNames + "' title='"+ this.tooltipTimezone +"' >";
      varCal += this.optionsTZ;
      varCal += "</select>";
      varCal += "</td>";
    }
	...
	varCal += "<table border='0' cellpadding='0' cellspacing='1' width='100%' class='" + this.borderClassName + "' >";
	varCal += "<tr >";
  ...
  //Week Days Row
	varCal += "<tr class='" + this.borderClassName + "'>";
	varCal += "<td style='cursor:pointer;cursor:default' align='center' class='" + this.borderClassName + " " + this.boldClassName + "'>S</td>";
	varCal += "<td style='cursor:pointer;cursor:default' align='center' class='" + this.borderClassName + " " + this.boldClassName +"'>M</td>";
	varCal += "<td style='cursor:pointer;cursor:default' align='center' class='" + this.borderClassName + " " + this.boldClassName +"'>T</td>";
	varCal += "<td style='cursor:pointer;cursor:default' align='center' class='" + this.borderClassName + " " + this.boldClassName +"'>W</td>";
	varCal += "<td style='cursor:pointer;cursor:default' align='center' class='" + this.borderClassName + " " + this.boldClassName +"'>T</td>";
	varCal += "<td style='cursor:pointer;cursor:default' align='center' class='" + this.borderClassName + " " + this.boldClassName +"'>F</td>";
	varCal += "<td style='cursor:pointer;cursor:default' align='center' class='" + this.borderClassName + " " + this.boldClassName +"'>S</td>";
	varCal += "</tr>";
      ...
      //Current Month Dates cells 
			if (DateLoop.getMonth()==this.selectedMonth){
				if(DateLoop.getDate()==this.localDate.getDate()||(DateLoop.getDay()==0)){	
						cellPrefix="<td class='" + this.borderClassName + " " + this.boldClassName +"' " 	
						cellSuffix="</td>";		
				}else{
						cellPrefix= "<td bgcolor='#ffffff' class='" + this.borderClassName + "' ";
						cellSuffix="</td>";	
				}
  ...
  //Todays Row
	varCal += "<tr>"; 
	varCal += "<td id='"+ this.calId + "todayNow' onclick='"+this.calId +".setToDay()' style='cursor:pointer; cursor:hand;' colspan='7' align='center' class='" + this.borderClassName + " " + this.boldClassName + "' title='"+ this.tooltipNow +"' >"
	varCal += "</td>";
	varCal += "</tr>";
  ...
  if(!this.noTime){
    ...
    varCal += "<select id='"+ this.calId + "cboHH' name='"+ this.calId + "cboHH' style='width:38x' class='" + this.textClassName + " ' title='"+ this.tooltipHour +"' >";
    varCal += this.options24;
    varCal += "</select>:";
    varCal += "<select id='"+ this.calId + "cboMM' name='"+ this.calId + "cboMM' style='width:38px' class='" + this.textClassName + " ' title='"+ this.tooltipMinute +"' >";
    varCal += this.options60;
    varCal += "</select>:";
    varCal += "<select id='"+ this.calId + "cboSS' name='"+ this.calId + "cboSS' style='width:38px' class='" + this.textClassName + "' title='"+ this.tooltipSecond +"' >";
    varCal += this.options60;
    varCal += "</select>";
    varCal += "</td>";
  }else{
...
function drawDatePicker(){
  ...
  // Default width is different if timezone and time measurement is not requried
	...
	document.write("<tr>");
	document.write("<td>");
	document.write("<input type='text' style='cursor:pointer;cursor:default; width:" + (this.calWidth-15) + "px; height:" + this.calHeight + "px;' class='" + this.textClassName + "' id='" + this.calId + "txtDate' name='" + this.calId + "txtDate' ")
...
function PickDate(theDate,cellId){
  ...
  BlinkSelected(this.calId,cellId);
}
...
function dateWithTimezone(varDate,varTimezoneName){
  ...
  var lastIndex=varDate.lastIndexOf(":")+3;
  varTimezoneName=(varTimezoneName==null)?"":varTimezoneName;
  return varDate.substring(0,lastIndex) + " " + varTimezoneName
}
