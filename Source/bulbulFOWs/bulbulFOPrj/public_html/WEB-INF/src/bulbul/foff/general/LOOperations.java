...
public abstract class LOOperations {
  private static Logger logger = Logger.getLogger(FOConstants.LOGGER.toString());

  public static byte[] getLargeObjectContent(int oId,
    ...
    try {
      ...
      conn =
        DriverManager.getConnection(basicDataSource.getUrl(), basicDataSource.getUsername(), basicDataSource.getPassword());
  ...
  public static void putLargeObjectContent(int oId, byte[] content,
                                           DataSource dataSource) throws ClassNotFoundException, SQLException,
                                                                                                  Exception {
  ...
  public static void removeLargeObjectId(DataSource dataSource,
                                         int oId) throws ClassNotFoundException, SQLException, Exception {
