 ...
 */
public class SvgImageDisplayAction extends Action  {
  /**
  ...
  public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
    ...
    try{
      logger.info("Entering SVG Image Display Action ");
      ...
      if (contentOId!=null){
        ...
        Operations.svgImageDisplay(content,contentType,Integer.parseInt(contentSize),response); 
      }
      ...
      logger.info("Exiting SVG Image Display Action ");
    }
    return null;
  }
}