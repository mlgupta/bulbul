...
public class SVGPath extends SVGShape  {
  ...
  private String shapepathlabel="Path";
  private String shapepathlabeloperations="Path Operations";
  private String shapepathlabelquadratic="Bezier Curve I";
  private String shapepathlabelcubic="Bezier Curve II";
  private String shapepathlabelunion="Union";
  private String shapepathlabelsubtraction="Subtraction";
  private String shapepathlabelintersection="Intersection";
  private String shapepathlabelconvert="Convert To Path";
  
  private String shapepathundoredocreatequadratic="Create Bezier Curve I";
  private String shapepathundoredocreatecubic="Create Bezier Curve II";
  private String shapepathundoredotranslate="Translate Path";
  private String shapepathundoredoresize="Resize Path";
  private String shapepathundoredorotate="Rotate Path";
  private String shapepathundoredomodifypoint="Modify Point";
  private String shapepathundoredounion="Union";
  private String shapepathundoredosubtraction="Subtraction";
  private String shapepathundoredointersection="Intersection";
  private String shapepathundoredoconvert="Convert To Path";
  
  private String shapepathhelpcreatequadratic="Draw a Bezier curve I";
  private String shapepathhelpcreatecubic="Draw a Bezier curve II ";
  ...
  public SVGPath(Studio studio) {
    ...
    try{
      labels.put("label", shapepathlabel);
      labels.put("labelpathoperations", shapepathlabeloperations);
      labels.put("labelquadratic", shapepathlabelquadratic);
      labels.put("labelcubic", shapepathlabelcubic);
      labels.put("labelunion", shapepathlabelunion);
      labels.put("labelsubtraction", shapepathlabelsubtraction);
      labels.put("labelintersection", shapepathlabelintersection);
      labels.put("labelconvert", shapepathlabelconvert);
      labels.put("undoredocreatequadratic", shapepathundoredocreatequadratic);
      labels.put("undoredocreatecubic", shapepathundoredocreatecubic);
      labels.put("undoredotranslate", shapepathundoredotranslate);
      labels.put("undoredoresize", shapepathundoredoresize);
      labels.put("undoredomodifypoint", shapepathundoredomodifypoint);
      labels.put("undoredorotate", shapepathundoredorotate);
      labels.put("undoredounion", shapepathundoredounion);
      labels.put("undoredosubtraction", shapepathundoredosubtraction);
      labels.put("undoredointersection", shapepathundoredointersection);
      labels.put("undoredoconvert", shapepathundoredoconvert);
      labels.put("helpcreatequadratic", shapepathhelpcreatequadratic);
      labels.put("helpcreatecubic", shapepathhelpcreatecubic);
		}catch (Exception ex){}	
