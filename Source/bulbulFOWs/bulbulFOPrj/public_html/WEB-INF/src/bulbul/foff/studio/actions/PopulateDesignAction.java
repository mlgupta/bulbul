...
public class PopulateDesignAction extends Action {
   /**
   ...
   public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
     ...
     try {
       logger.info("Entering Populate Design Action");
       customerDesignTblPk=Integer.parseInt(request.getParameter("customerDesignTblPk"));
       dataSource=getDataSource(request,"FOKey");
       logger.info("customerDesignTblPk is : " +customerDesignTblPk );
       xmlStringOutput=Operations.populateDesign(dataSource,customerDesignTblPk);
