...
public class GetPrintableAreaAction extends Action {
  ...
  public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request,
    ...
    logger.info("Entering GetPrintableAreaAction");
    try{
      if(request.getParameter("merchandiseColorTblPk")!=null){
        merchandiseColorTblPk=Integer.parseInt(request.getParameter("merchandiseColorTblPk"));  
      }
      dataSource= getDataSource(request,"BOKey");
      xmlStringOutput=Operations.getPrintableAreasXMLString(dataSource,merchandiseColorTblPk);
    ...
    logger.info("Exiting GetPrintableAreaAction");
    return null;
  }
}
