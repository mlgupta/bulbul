...
public class ProductCategoryNavigationListAction extends Action {
   ...
   public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request,
     ...
     logger.info("Entering ProductCategoryNavigationListAction");
     try{
       ...
       xmlStringOutput=Operations.getMerchandiseCategoryNavigationListXML(merchandiseCategoryTblPk,dataSource);
     ...
     logger.info("Exiting ProductCategoryNavigationListAction");
     return null;     
   }
}
