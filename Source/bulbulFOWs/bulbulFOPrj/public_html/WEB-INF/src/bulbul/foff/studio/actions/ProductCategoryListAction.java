...
public class ProductCategoryListAction extends Action {
   ...
   public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request,
     ...
     logger.info("Entering ProductCategoryListAction");
     try{
       ...
       xmlStringOutput=Operations.getMerchandiseCategoryListXML(merchandiseCategoryTblPk,dataSource);
     ...
     logger.info("Exiting ProductCategoryListAction");
     return null;     
   }
}
