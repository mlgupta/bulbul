...
public class ProductTreeView  {
  ...
  public ProductTreeView(String treeId, 
                  String physicalPath, 
                  String iconPath, 
                  String userId, 
                  String sessionId,
    ...
    logger = Logger.getLogger(FOConstants.LOGGER.toString());
    try{
  ...
  public void initTree()throws IOException,Exception{
    ...
    try{
      ...
      initTreeString.append("USEICONS = 0" + "\n");
      initTreeString.append("PERSERVESTATE = 1" + "\n");
      initTreeString.append("HIGHLIGHT_COLOR = '#FFFFFF'\n");
      initTreeString.append("HIGHLIGHT_BG    = '#01A0BF'\n");
      ...
      initTreeString.append("foldersTree.morc=\"1\";");
      initTreeString.append("\n");
    ...
    try{
        while(rs.next()){
          if (this.categoryOnly ){
            String categoryPk=rs.getString("merchandise_category_tbl_pk");
            String categoryName=rs.getString("merchandise_category");
            String morc=rs.getString("m_or_c");
            ...
            if (!(isCategoryPersists)) {  
              ...
              sqlString+="\n m_or_c ";
              sqlString+="\n from merchandise_category_tbl ";
              sqlString+="\n where merchandise_category_tbl_fk ="+ categoryPk;
              sqlString+="\n and is_active=1 ";
              sqlString+="\n and sp_no_of_items_m_or_c(merchandise_category_tbl_pk,m_or_c)>0  ";
              sqlString+="\n order by merchandise_category ";
              ...
              logger.debug(" Sql String For Checking Child Exist or Not " + sqlString );
              logger.debug(" Child Exist " + childExists );
              ...
              //treeOfItems.append("\n");
              treeOfItems.append(child + ".morc=\""+ morc + "\";");
              treeOfItems.append("\n");
              treeOfItems.append("insFld(" + parent + "," + child + ");"  + "\n" );
            }
          }else{
            child="obj" + rs.getString("merchandise_category_tbl_pk");
            treeOfItems.append("\n");
            treeOfItems.append(child + "= gLnk(\"S\",\"" + rs.getString("merchandise_category") + "\"," + "true" + ");");
            treeOfItems.append("\n");
            treeOfItems.append(child + ".xID=\""+ rs.getString("merchandise_category_tbl_pk") + "\";");
            treeOfItems.append("\n");
           // treeOfItems.append(child + ".path=\""+  "a/b/c" + "\";");
           // treeOfItems.append("\n");           
           treeOfItems.append(child + ".morc=\""+  rs.getString("m_or_c") + "\";");
           treeOfItems.append("\n");
        ...
        if ( level < this.treeLevel) {
          while (rs.next()){
            String sqlString;
            String pk=rs.getString("merchandise_category_tbl_pk");
            sqlString="\n select ";
            sqlString+="\n merchandise_category_tbl_pk, ";
            sqlString+="\n merchandise_category, ";
            sqlString+="\n merchandise_category_description, ";
            sqlString+="\n m_or_c ";
            sqlString+="\n from merchandise_category_tbl ";
            sqlString+="\n where merchandise_category_tbl_fk ="+ pk;
            sqlString+="\n and is_active=1 ";
            sqlString+="\n and sp_no_of_items_m_or_c(merchandise_category_tbl_pk,m_or_c)>0  ";
            sqlString+="\n order by merchandise_category ";
 ...
 */  
  ...
  public void ifCategoryDeleted(String categoryPk, String parentCategoryPk)throws IOException,Exception{
    ...
    try{
      ...
      if(parentCategoryPk.equals("-1")){
        ...
        sqlString+="\n where merchandise_category_tbl_fk ="+ parentCategoryPk;
      }
      sqlString+="\n and is_active=1 ";
      sqlString+="\n and sp_no_of_items_m_or_c(merchandise_category_tbl_pk,m_or_c)>0  ";
      sqlString+="\n order by merchandise_category ";
      ...
      rs = dBConnection.executeQuery(sqlString,ResultSet.TYPE_SCROLL_INSENSITIVE,ResultSet.CONCUR_READ_ONLY);
      while (rs.next()){
        siblingOrParentCategoryPk=rs.getString("merchandise_category_tbl_pk");
        break;
      }
    ...
    try{
      ...
      if(!isJsFileCreated4Category){ 
        ...
        if(categoryPk.equals("-1")){
          sqlString+="\n where merchandise_category_tbl_pk is null " ;
        }else{
          sqlString+="\n where merchandise_category_tbl_pk ="+ categoryPk;
        }
        sqlString+="\n and is_active=1 ";
        sqlString+="\n and sp_no_of_items_m_or_c(merchandise_category_tbl_pk,m_or_c)>0  ";
        sqlString+="\n order by merchandise_category ";
        ...
        if(resultSet.next()){
          String ancesstorCategoryPk=resultSet.getString("merchandise_category_tbl_fk") ; 
          if (ancesstorCategoryPk!=null){
  ...
  * @param id - A String object defined by the Id of the current Category in the List
  * @return void
  */
