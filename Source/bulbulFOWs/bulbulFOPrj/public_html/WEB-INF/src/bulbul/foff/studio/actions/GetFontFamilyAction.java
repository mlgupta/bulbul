...
public class GetFontFamilyAction extends Action {
...
//    logger.info("Entering GetFontFamilyAction");
    try{
      ...
      xmlStringOutput=Operations.getFontXMLString(fontCategoryTblPk,dataSource,pageNumber);
//          xmlStringOutput=Operations.fontFamilyInXML.toString();
...
//    logger.info("Exiting GetFontFamilyAction");
    return null;
  }
}
