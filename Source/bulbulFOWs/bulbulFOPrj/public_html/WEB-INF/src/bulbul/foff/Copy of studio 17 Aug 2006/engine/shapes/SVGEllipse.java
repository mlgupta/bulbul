...
public class SVGEllipse extends SVGShape  {
  ...
  private String shapeellipselabel="Ellipse";
  
  private String shapeellipseundoredocreate="Create Ellipse";
  private String shapeellipseundoredotranslate="Translate Ellipse";
  private String shapeellipseundoredoresize="Resize Ellipse";
  private String shapeellipseundoredorotate="Rotate Ellipse";
  
  private String shapeellipsehelpcreate="Draw an ellipse";
   ...
   * @param studio
   */
  public SVGEllipse(Studio studio) {
    super(studio);
    ids.put("id","ellipse");
    
    try{
				labels.put("label", shapeellipselabel);
				labels.put("undoredocreate", shapeellipseundoredocreate);
				labels.put("undoredotranslate", shapeellipseundoredotranslate);
				labels.put("undoredoresize", shapeellipseundoredoresize);
				labels.put("undoredorotate", shapeellipseundoredorotate);
				labels.put("helpcreate", shapeellipsehelpcreate);
		}catch (Exception ex){}
