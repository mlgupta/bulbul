...
public class ClipartCategoryNavigationListAction extends Action {
  ...
  public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request,
    ...
    logger.info("Entering ClipartCategoryNavigationListAction");
    try{
      ...
      xmlStringOutput=Operations.getClipartCategoryNavigationListXML(clipartCategoryTblPk,dataSource);
    ...
    logger.info("Exiting ClipartCategoryNavigationListAction");
    return null;
