...
function NavigationBar(barId){
  ...
  this.refresh=Toggle;
	...
	this.className='bdrColor_336666';
...
function DrawBar(){
	...
	document.write("<input type='text'  id='" + this.barId+ "txtPageNo' name='" + this.barId+ "txtPageNo' class='" + this.className +"' style='text-align:right; width:100%'  size='3' onkeypress='return integerOnly(event);' value='" + this.pageNumber + "' title='"+this.tooltipPageNo+"' >");
	...
	document.write("<td id='"+this.barId+"PageCount' width='30px' align='center'>");
...
function Toggle(){
  ...
  var objPageCount=MM_findObj(this.barId+"PageCount");
  ...
  objPageCount.innerHTML=varPageCount;
  
  var barIdValue=this.barId;   
  ...
  if (varPageNumber==1 && varPageCount==varPageNumber){
    ...
    objNext.onclick=function(){ 
      eval(barIdValue+'.moveNext()');
    };

    objLast.className="imgNavLast";
    
    objLast.onclick=function(){ 
      eval(barIdValue+'.moveLast()');
    };
    ...
    objFirst.onclick=function(){ 
      eval(barIdValue+'.moveFirst()');
    };
    
    objPrev.className="imgNavPrev";
    
    objPrev.onclick=function(){ 
      eval(barIdValue+'.movePrev()');
    };
