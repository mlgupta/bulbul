...
function widnow_onload(){
  var objRadioColor=MM_findObj('radColor');
...
function btnCustomise_onclick(){
  ...
  var studioFrameSrc=escape('productCustomiseB4Action.do?merchandiseTblPk=<bean:write name="productDetail" property="merchandiseTblPk"/>&merchandiseColorTblPk='+ merchandiseColorTblPk);
...
<body onload="return widnow_onload();">
  <!-- Seperator Table -->                                    
  ...
  <table width="725px" border="0" align="center" cellpadding="0" cellspacing="0">
    <tr>
      ...
      <td width="696px" background="images/myprntn_pan_tile17px.gif" class="heading_pan"><bean:message key="page.ProductDetails" /> :</td>
      <td width="5px"><img src="images/myprntn_pan_corner_rt.gif" width="5px" height="17px"></td>
    </tr>
	  <tr>
	    <td height="20px" bgcolor="#FFFFFF" colspan="3" class="bdrLeftColor_006600 bdrRightColor_006600 bdrTopColor_006600 bdrBottomColor_006600">
        &nbsp;<a class="linkMenu" href="myFavouriteListAction.do?category=<bean:write name="category" />&pageNumber=<bean:write name="pageNumber" />">&nbsp;&lt; <bean:message key="nav.Back" />&nbsp;</a>
      </td>
  	</tr>
	  <tr>
      <td bgcolor="#FFFFFF" colspan="3" class="bdrLeftColor_006600 bdrRightColor_006600 bdrBottomColor_006600">        
          ...
          <tr>
            <td valign="top">	
              ...
              <table width="450px"  border="0" cellpadding="1" cellspacing="1">
                <tr>
                  <td width="100%" height="20px" class="text_006600"><div align="center"><bean:write name="productDetail" property="name" /></div></td>
                </tr>
                <tr>
                  <td height="20px" >
                        <div align="center" >
                          <img name="display" class="bdrColor_006600" id="display" border="0" style="width:200px; height:200px; background-color:#FFFFFF" src="imageDisplayAction.do?dataSourceKey=BOKey&imageOid=<bean:write name="productDetail" property="productOId"/>&imageContentType=<bean:write name="productDetail" property="productContentType"/>&imageContentSize=<bean:write name="productDetail" property="productContentSize"/>" ></img>
                        </div>
                  </td>
                </tr>
                <tr>
            ...
            <td align="right" valign="top">
              ...
              <table width="255px"  border="0" cellpadding="1" cellspacing="1">
                <tr>
                  <td height="10px">
                    <!-- Color Table Starts-->      
                    <table width="250px"  border="0" cellspacing="1" cellpadding="1" class="bgColor_006600">
                      <tr>
                        <td class="th_0A8A09" colspan="3"><div align="center"><bean:message key="tbl.Colors" /></div></td>
                      </tr>
                      <logic:iterate id="productColor" name="productColors">
                        <tr bgcolor="#FFFFFF">
                          ...
                          <td width="14%">
                            <div style="height:18px;width:36px;align:center" class="bdrColor_006600">
                  ...
                  <td height="20px" >
                    <logic:iterate id="productColor" name="productColors">
                      ...
                      <div style="position:relative;display:none;" id="lyr<bean:write name="productColor" property="merchandiseColorTblPk" />" name="lyr<bean:write name="productColor" property="merchandiseColorTblPk" />">
                        <table width="250px"  border="0" cellspacing="1" cellpadding="2" class="bgColor_006600">
                          <tr>
                            <td class="th_0A8A09" width="33%"><div align="center"><bean:message key="tbl.Size" /></div></td>
                            <td class="th_0A8A09" width="36%"><div align="center"><bean:message key="tbl.Price/Quantity" /></div></td>
                            <td class="th_0A8A09" width="31%"><div align="center"><bean:message key="tbl.Discount" /></div></td>
                          </tr>
        ...
        <table width="100%"  border="0" align="center" cellpadding="2" cellspacing="1" class="bdrTopColor_006600">
          <tr>
            <td width="20%" valign="top" class="text_006600"><div align="right"><bean:message key="info.ProductDescription" />:</div></td>
            <td width="80%"><bean:write name="productDetail" property="description" /></td>
          </tr>
          <tr>
            <td valign="top" class="text_006600"><div align="right"><bean:message key="info.MaterialDetail" />:</div></td>
            <td><bean:write name="productDetail" property="materialDetail" /></td>
          </tr>
          <tr>
            <td valign="top" class="text_006600"><div align="right"><bean:message key="info.DeliveryNote" />:</div></td>
            <td><bean:write name="productDetail" property="deliveryNote" /></td>
          </tr>
          <tr>
            <td valign="top" class="text_006600"><div align="right"><bean:message key="info.MinimumQuantity" />:</div></td>
            <td><bean:write name="productDetail" property="minQty" /></td>
          </tr>
          <tr>
            <td valign="top" class="text_006600"><div align="right"><bean:message key="info.Comment" />:</div></td>
    ...
    <tr>
      <td bgcolor="#FFFFFF" colspan="3" class="bdrLeftColor_006600 bdrRightColor_006600">&nbsp;</td>
    </tr>
    <tr>
