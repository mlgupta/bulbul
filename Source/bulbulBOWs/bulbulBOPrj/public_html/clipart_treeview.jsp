...
<bean:define id="jsFileLinks" name="clipartTreeView" property="jsFileLinks" />
<bean:define id="jsFileName" name="clipartTreeView" property="jsFileName" />
<bean:define id="treeOperation" name="treeOperation"  />

<html>
<head>
<title>Clipart Tree View</title>
...
function window_onload(){
  ...
  <logic:equal name="treeOperation"  value="clipart_tree_view">
...
function userDefinedClickOnFolder(folderId){
  window.top.location.replace("clipartRelayAction.do?hdnSearchOperation=clipart_list&clipartOrCategoryTblPk="+ folderId  );		     
}

function userDefinedClickOnNode(folderId){
  window.location.replace('clipartRelayAction.do?hdnSearchOperation=clipart_tree_view_append&selectedCategoryPk='+ folderId + '&currentCategoryPk=<%=currentCategoryPk%>'  );	
}
