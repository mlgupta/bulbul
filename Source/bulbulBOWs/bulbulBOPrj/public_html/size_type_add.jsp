...
<HTML>
<HEAD>  
  <TITLE><bean:message key="title.SizeTypeAdd" /></TITLE>
...
<BODY>
<html:form action="/sizeTypeAddAction" >
  ...
  <tr>
    <td height="507px" class="bgColor_DFE7EC bdrTopColor_333333 bdrLeftColor_333333 bdrBottomColor_333333 bdrRightColor_333333">
      <table width="500px"  border="0" align="center" class="bdrColor_336666">
        <tr>
          <th height="20px" colspan="3"><div align="center"><bean:message key="page.SizeTypeAdd" /></div></th>
        </tr>
        <tr>
          <td colspan="3">&nbsp;</td>
        </tr>
