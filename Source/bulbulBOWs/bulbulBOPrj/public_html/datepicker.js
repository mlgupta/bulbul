...
function ShowCalendar(theDate){
	...
	varCal ="<table border='0'  cellspacing='2' cellpadding='1' class='bdrColor_336666 bgColor_DFE7EC' width='"+ this.calWidth + "px' >";	
  ...
  //Timezone combo 
    ...
    if (eval(this.timezoneDisabled)){
      ...
      varCal += "<th colspan='7' align='center' class='bdrColor_336666' >";

      varCal += this.selectedTimezoneName

      varCal += "<select id='"+ this.calId + "cboTZ' name='"+ this.calId + "cboTZ' style='display:none; width:"+ (this.calWidth-10) + "px' onchange='"+ this.calId + ".tzOnChange()' class='bdrColor_336666 ' title='"+ this.tooltipTimezone +"' >";
      ...
      varCal += "<td colspan='7' align='center' class='bdrColor_336666' >";

      varCal += "<select id='"+ this.calId + "cboTZ' name='"+ this.calId + "cboTZ' style='width:"+ (this.calWidth-10) + "px' onchange='"+ this.calId + ".tzOnChange()' class='bdrColor_336666' title='"+ this.tooltipTimezone +"' >";
	...
	varCal += "<table border='0' cellpadding='0' cellspacing='1' width='100%' class='bdrColor_336666' >";
  ...
  //Week Days Row
	...
	varCal += "<tr class='bdrColor_336666'>";

	varCal += "<th style='cursor:pointer;cursor:default' align='center' class='bdrColor_336666'>S</th>";

	varCal += "<th style='cursor:pointer;cursor:default' align='center' class='bdrColor_336666'>M</th>";

	varCal += "<th style='cursor:pointer;cursor:default' align='center' class='bdrColor_336666'>T</th>";

	varCal += "<th style='cursor:pointer;cursor:default' align='center' class='bdrColor_336666'>W</th>";

	varCal += "<th style='cursor:pointer;cursor:default' align='center' class='bdrColor_336666'>T</th>";

	varCal += "<th style='cursor:pointer;cursor:default' align='center' class='bdrColor_336666'>F</th>";
      ...
      //Current Month Dates cells 
			...
			if (DateLoop.getMonth()==this.selectedMonth){
				...
				if(DateLoop.getDate()==this.localDate.getDate()||(DateLoop.getDay()==0)){	
						...
						cellPrefix="<th class='bdrColor_336666' " 	

						cellSuffix="</th>";		

				}else{

						cellPrefix= "<td bgcolor='#ffffff' class='bdrColor_336666' ";
  ...
  //Todays Row
	...
	varCal += "<th id='"+ this.calId + "todayNow' onclick='"+this.calId +".setToDay()' style='cursor:pointer; cursor:hand;' colspan='7' align='center' class='bdrColor_336666' title='"+ this.tooltipNow +"' >"
  ...
  if(!this.noTime){
    ...
    varCal += "<select id='"+ this.calId + "cboHH' name='"+ this.calId + "cboHH' style='width:38x' class='bdrColor_336666 ' title='"+ this.tooltipHour +"' >";

    varCal += this.options24;

    varCal += "</select>:";

    varCal += "<select id='"+ this.calId + "cboMM' name='"+ this.calId + "cboMM' style='width:38px' class='bdrColor_336666 ' title='"+ this.tooltipMinute +"' >";

    varCal += this.options60;

    varCal += "</select>:";

    varCal += "<select id='"+ this.calId + "cboSS' name='"+ this.calId + "cboSS' style='width:38px' class='bdrColor_336666' title='"+ this.tooltipSecond +"' >";
...
function drawDatePicker(){
  ...
  // Default width is different if timezone and time measurement is not requried
	...
	document.write("<input type='text' style='cursor:pointer;cursor:default; width:" + (this.calWidth-15) + "px; height:" + this.calHeight + "px;' class='bdrColor_336666' id='" + this.calId + "txtDate' name='" + this.calId + "txtDate' ")
