...
<bean:define id="jsFileLinks" name="merchandiseCategoryTreeView" property="jsFileLinks" />
<bean:define id="jsFileName" name="merchandiseCategoryTreeView" property="jsFileName" />
<bean:define id="treeOperation" name="treeOperation"  />

<html>
<head>
<title>Merchandise Category1 Tree View</title>
...
function window_onload(){
  ...
  <logic:equal name="treeOperation"  value="merchand_tree_view">
...
function userDefinedClickOnNode(folderId){
  window.location.replace('merchandiseRelayAction.do?hdnSearchOperation=merchand_category_tree_view_append&selectedCategoryPk='+ folderId + '&currentCategoryPk=<%=currentCategoryPk%>'  );	
}
