...
//Global Constants
var	COLORS_216=new Array('00','33','66','99','cc','ff');
var	COLORS_4096=new Array('00','11','22','33','44','55','66','77','88','99','aa','bb','cc','dd','ee','ff');
...
function drawPalette(){
    ...
    document.write('<table width="100%" border="0" cellpadding="0" cellspacing="1" class="bdrColor_336666" >');
		document.write("<tr>");
    ...
    document.write('<table>'); 
    document.write('<tr>'); 
    document.write('<td id="'+ this.paletteId + 'hexovercolor" name="'+ this.paletteId + 'hexovercolor" width="60px" class="bdrColor_336666">&nbsp;</td>');
    document.write("</tr>"); 
    document.write("</table>"); 
    document.write("</td>");
    ...
    document.write('<table>'); 
    document.write('<tr>'); 
    document.write('<td id="'+ this.paletteId + 'hexvalue" name="hexval" width="60px" align="center" class="bdrColor_336666">#ffffff</td>');
    document.write('<td id="'+ this.paletteId + 'hexcolor" name="hexval" width="60px" class="bdrColor_336666">&nbsp;</td>');
    document.write("</tr>"); 
    document.write("</table>"); 
    document.write("</tr>");
    document.write("</table>");
