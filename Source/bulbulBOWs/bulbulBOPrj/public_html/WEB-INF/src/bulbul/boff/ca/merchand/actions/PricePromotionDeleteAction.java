...
public class PricePromotionDeleteAction extends Action  {
  ...
  public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
    ...
    logger.info("Entering PricePromotionDeleteAction");
    try{

      Operations.deletePricePromotion(pricePromotionTblPk,dataSource);  
      ...
      if((e.getMessage().indexOf(ErrorConstants.REFERED.getErrorValue()))>-1){
        ActionMessage msg=new ActionMessage("msg.Refered","Price Definition");
      ...
      logger.info("Exiting PricePromotionDeleteAction");
    }
