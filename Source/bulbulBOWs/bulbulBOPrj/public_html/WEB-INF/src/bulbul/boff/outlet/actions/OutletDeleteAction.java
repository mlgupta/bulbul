...
/**
 *	Purpose: To Delete An Outlet From The outlet_list.jsp.
 *  Info: This Class Will Delete An Outlet From The outlet_list.jsp. It Uses deleteOutlet() Method and Passes It The 
 *        Primary Key Of The Selected Outlet Which Is To Be Deleted.
 *  @author               Amit Mishra
 *  @version              1.0
 ...
 * 	Last Modfied Date:    
 */
public class OutletDeleteAction extends Action  {
  ...
  public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
    ...
    try{
      ...
      Operations.deleteOutlet(outletTblPk,dataSource);  
      ...
      logger.info("Exiting Outlet Delete Action");
    }
