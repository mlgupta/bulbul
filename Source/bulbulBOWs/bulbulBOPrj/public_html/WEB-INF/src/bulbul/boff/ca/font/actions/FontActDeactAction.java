...
/**
 *	Purpose: To Activate Or Deactivate The Selected Font In The font_list.jsp. 
 *  Info: This Class Will Take The Primary Key Of The Selected Font And Pass It To The actDeactFont() Method
...
public class
 ...
 FontActDeactAction extends Action  {
  ...
  public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
    ...
    logger.info("***Entering FontActDeactAction***");
    try{
      Operations.actDeactFont(fontTblPk,fontListForm,dataSource);  
    }catch(Exception e){
      logger.error("Caught Exception: "+e);
    }
    logger.info("***Exiting FontActDeactAction***");
