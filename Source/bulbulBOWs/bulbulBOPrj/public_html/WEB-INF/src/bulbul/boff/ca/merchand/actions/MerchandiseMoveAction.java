...
public class MerchandiseMoveAction extends Action  {
  ...
  public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
    ...
    logger.info("Entering MerchandiseMoveAction");
    ...
    try{
      ...
      Operations.moveMerchandise(srcMerchandiseTblPk,srcCategoryTblPk,trgCategoryTblPk,dataSource);
      ...
      if((e.getMessage().indexOf("merchandise_only"))>-1){
        ActionMessage msg=new ActionMessage("msg.MerchandiseMoveToCategory");
        messages.add("message2" ,msg);
      }
