...
public class FontTreeViewAction extends Action  {
  ...
  public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
    ...
    try{
      ...
      logger.info("***Entering FontTreeViewAction***");
      ...
      request.setAttribute("treeOperation","font_tree_view");     
      ...
      if (httpSession.getAttribute("fontTreeView")==null){
        Treeview fontTreeView = new Treeview("FontCat",
                                    ...
                                    true);
        httpSession.setAttribute("fontTreeView",fontTreeView);
      }
    }
    catch(Exception e){
      return mapping.getInputForward();
    }finally{
          logger.info("Exiting FontTreeViewAction");
    }
