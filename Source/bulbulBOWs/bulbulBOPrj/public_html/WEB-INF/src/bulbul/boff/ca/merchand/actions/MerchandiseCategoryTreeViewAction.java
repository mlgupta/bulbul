...
public class MerchandiseCategoryTreeViewAction extends Action  {
  ...
  public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
    ...
    try{
      ...
      logger.info("Entering MerchandiseCategoryTreeViewAction");
      ...
      if(request.getParameter("currentCategoryPk")!=null){
        ...
        logger.debug("clipartCategoryTblPk is: "+merchandiseCategoryTblPk);
      }
      request.setAttribute("currentCategoryPk",merchandiseCategoryTblPk);     
      request.setAttribute("treeOperation","merchandise_category_tree_view");     
      ...
      if (httpSession.getAttribute("merchandiseCategoryTreeView")==null){
        Treeview merchandiseCategoryTreeView = new Treeview("MerchandiseCat",
                                    ...
                                    true);
        httpSession.setAttribute("merchandiseCategoryTreeView",merchandiseCategoryTreeView);
      }
    }
    catch(Exception e){
      return mapping.getInputForward();
    }finally{
          logger.info("Exiting MerchandiseCategoryTreeViewAction");
    }
