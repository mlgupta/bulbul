...
public class MerchandiseDecorationAddAction extends Action  {
  ...
  public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
    ...
    try{
      logger.info("Entering MerchandiseDecorationAddAction");
      ...
      Operations.addDecoration(merchandiseDecorationForm,dataSource); 
      ...
      logger.info("Exiting MerchandiseDecorationAddAction");
    }
    return mapping.findForward("success");
  }
}