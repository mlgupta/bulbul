...
public class MerchandiseDecorationEditB4Action extends Action  {
  ...
  public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
    ...
    try{
      logger.info("Entering MerchandiseDecorationEditB4Action");
      ...
      logger.debug("merchandiseDecorationTblPk: "+merchandiseDecorationTblPk);
      ...
      logger.info("Exiting MerchandiseDecorationEditB4Action");
    }
