...
public class MerchandiseCategoryRelayAction extends Action  {
  Logger logger=Logger.getLogger(BOConstants.LOGGER.toString());

  public ActionForward execute(ActionMapping mapping, ActionForm form,HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
  String operation= new String("null") ;
  operation=request.getParameter("hdnOperation");
  logger.info("Entering MerchandiseCategoryRelayAction.. OPERATION:"+"***"+operation+"***");
  if (operation==null)
  {
  ...
  logger.info("***Exiting MerchandiseCategoryRelayAction***");
