...
public class PrintableAreaAddAction extends Action  {
  ...
  public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
    ...
    try{
      logger.info("Entering PrintableAreaAddAction");
      ...
      Operations.addPrintableArea(printableAreaForm,dataSource); 
      ...
      logger.info("Exiting PrintableAreaAddAction");
    }
    return mapping.findForward("success");
  }
