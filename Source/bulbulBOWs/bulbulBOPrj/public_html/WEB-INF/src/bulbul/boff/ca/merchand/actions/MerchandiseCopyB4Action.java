...
public class MerchandiseCopyB4Action extends Action  {
  ...
  public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
    ...
    logger.info("Entering MerchandiseCopyB4Action");
    ...
    merchandiseCategoryListForm.setHdnOperation("merchand_copy");
    ...
    logger.info("Exiting MerchandiseCopyB4Action");
