...
public class MerchandisePrintableAreaEditB4Action extends Action  {
  ...
  public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
    ...
    try {
      logger.info("Entering MerchandisePrintableAreaEditB4Action");
      ...
      logger.info("Exiting MerchandisePrintableAreaEditB4Action");
    }
