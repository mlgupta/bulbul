...
public class ClipartTreeViewAction extends Action  {
  ...
  public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
    ...
    try{
      ...
      logger.info("***Entering ClipartTreeViewAction***");
      ...
      request.setAttribute("treeOperation","clipart_tree_view");     
      ...
      if (httpSession.getAttribute("clipartTreeView")==null){
        Treeview clipartTreeView = new Treeview("ClipartCat",
                                    ...
                                    true);
        httpSession.setAttribute("clipartTreeView",clipartTreeView);
      }
    }
    catch(Exception e){
      return mapping.getInputForward();
    }finally{
          logger.info("Exiting ClipartTreeViewAction");
    }
