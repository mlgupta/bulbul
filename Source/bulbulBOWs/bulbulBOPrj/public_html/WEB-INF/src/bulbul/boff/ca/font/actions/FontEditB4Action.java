...
/**
 *	Purpose: To Populate The FontForm Before Editing.
 *  Info: This Class Will Retrieve The Font From The Database And Populates The FontForm With The 
 *        Retrieved Values.It Uses viewFont() Method To Populate The FontForm.
 *  @author               Amit Mishra
 *  @version              1.0
...
FontEditB4Action extends Action  {
  ...
  public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
    ...
    try{
      logger.info("Entering FontEditB4Action");
     ...
     return mapping.getInputForward();
      ...
      logger.info("Exiting FontEditB4Action");
    }
