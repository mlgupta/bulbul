...
public class SizeEditAction extends Action  {
  ...
  public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
    ...
    try{
      logger.info("Entering SizeEditAction");
      ...
      Operations.editSize(sizeForm,dataSource);
      ...
      e.printStackTrace();
      logger.error("Exception Caught in SizeEditAction: "+e.getMessage());
      return mapping.getInputForward();
    }finally{
      logger.info("Exiting SizeEditAction");
    }
    return mapping.findForward("success");
  }
}