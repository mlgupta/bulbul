...
public class PricePromotionAddAction extends Action  {
  ...
  public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
    ...
    logger.info("Entering PricePromotionAddAction");
    ...
    try{
      ...
      Operations.addPricePromotion(pricePromotionForm,dataSource); 
      ...
      logger.info("Exiting PricePromotionAddAction***");
    }
    return mapping.findForward("success");
  }
