...
public class MerchandiseCategoryActDeactAction extends Action  {
  ...
  public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
    ...
    logger.info(" Entering MerchandiseCategoryActDeactAction ");
    try{
      Operations.actDeactMerchandiseCategory(merchandiseCategoryTblPk,merchandiseListForm,dataSource);  
    }catch(Exception e){
      logger.error("Caught Exception: "+e);
    }
    logger.info(" Exiting MerchandiseCategoryActDeactAction ");
