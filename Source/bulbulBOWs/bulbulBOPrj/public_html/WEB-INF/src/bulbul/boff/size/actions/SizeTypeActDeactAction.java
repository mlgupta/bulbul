...
public class SizeTypeActDeactAction extends Action  {
  ...
  public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
    ...
    logger.info("Entering SizeTypeActDeactAction");
    try{
      Operations.actDeactSizeType(sizeTypeTblPk,sizeTypeListForm,dataSource);  
    }catch(Exception e){
      logger.error("Caught Exception: "+e);
    }
    logger.info("Exiting SizeTypeActDeactAction");
