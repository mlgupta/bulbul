...
public class MerchandisePrintableAreaEditAction extends Action  {
  ...
  public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
    ...
    try {
      logger.info("Entering MerchandisePrintableAreaEditAction");
      ...
      Operations.editPrintableAreaDetals(merchandiseForm,dataSource);
      ...
      logger.info("Exiting MerchandisePrintableAreaEditAction");
    }
    return mapping.findForward("success");
  }
}