...
<HTML>
  <HEAD>  
    <TITLE><bean:message  key="title.OutletEdit" /> </TITLE>
  ...
  <BODY >
  <html:form  action="/outletEditAction">
   <html:hidden property="hdnOutletTblPk" />
   <html:hidden property="hdnSearchPageNo" /> 
    ...
    <table width="970px" border="0" align="center" cellpadding="0" cellspacing="0">
      ...
      <table width="500px"  border="0" align="center" class="bdrColor_336666">
        <tr>
          <th height="20px" colspan="4"><div align="center"><bean:message  key="page.OutletEdit"/></div></th>
        </tr>
        <tr>
          <td colspan="4">&nbsp;</td>
        </tr>
        ...
        <tr>
          ...
          <td colspan="2">
            <html:textarea property="txaOutletDesc" cols="" rows="4" styleClass="bdrColor_336666"   style="width:300px" tabindex="3" /> 
          </td>
          <td>&nbsp;</td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td width="176px"><div align="right">
            ...
            <html:select property="cboState" styleClass="bdrColor_336666" style="width:120px" tabindex="8">
             <html:option value="Maharashtra">
              Maharashtra
             </html:option>
             <html:option value="UttarPradesh">
              UttarPradesh
             </html:option>
            </html:select>
            </div>
        ...
        <tr>
          ...
          <td> <div align="right"><bean:message  key="cbo.Country"/> 
            <html:select property="cboCountry" styleClass="bdrColor_336666" style="width:120px" tabindex="10">
        ...
        <tr>
          ...
          <html:reset property="btnClear" styleClass="buttons"  tabindex="13"><bean:message  key="btn.Clear" /></html:reset>
          </div></td>
          <td>&nbsp;</td>
        </tr>
        <tr>
