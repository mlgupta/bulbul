...
<HTML>
<HEAD>  
  <TITLE><bean:message key="title.ClipartCategoryAdd" /></TITLE>
...
<BODY>
<html:form action="/clipartCategoryAddAction">
  ...
  <tr>
    <td height="507px" class="bgColor_DFE7EC bdrTopColor_333333 bdrLeftColor_333333 bdrBottomColor_333333 bdrRightColor_333333">
      <table width="500px"  border="0" align="center" class="bdrColor_336666">
        <tr>
          <th height="20px" colspan="3"><div align="center"><bean:message key="page.ClipartCategoryAdd" /></div></th>
        </tr>
        <tr>
          <td colspan="3">&nbsp;</td>
        </tr>
        ...
        <tr>
          ...
          <td>
            <div align="right">
              <html:textarea property="txaClipartCategoryDesc" cols="" rows="4" styleClass="bdrColor_336666" style="width:300px"></html:textarea>
            </div>
          </td>
          <td>&nbsp;</td>
        </tr>
