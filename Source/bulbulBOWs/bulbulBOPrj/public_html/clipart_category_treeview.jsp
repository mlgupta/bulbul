...
<bean:define id="jsFileLinks" name="clipartCategoryTreeView" property="jsFileLinks" />
<bean:define id="jsFileName" name="clipartCategoryTreeView" property="jsFileName" />
<bean:define id="treeOperation" name="treeOperation"  />

<html>
<head>
<title>Clipart Category Tree View</title>
...
function userDefinedClickOnNode(folderId){
  window.location.replace('clipartRelayAction.do?hdnSearchOperation=clipart_category_tree_view_append&selectedCategoryPk='+ folderId + '&currentCategoryPk=<%=currentCategoryPk%>'  );	
}
