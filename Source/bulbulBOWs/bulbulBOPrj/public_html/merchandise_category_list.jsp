...
<html>
<head>
  <title><bean:message key="title.MerchandiseCategoryList" /></title>
    ...
    function btnclick(operation){
      ...
      if ((operation=='ok' ) ){
        ...
        if(thisForm.hdnSrcCategoryTblPk.value == thisForm.hdnTrgCategoryTblPk.value){
          if(thisForm.hdnOperation.value=='merchand_move'){
            alert('<bean:message key="alert.same.category.move" />');
            return false;
          }
          if(thisForm.hdnOperation.value=='merchand_copy'){
            alert('<bean:message key="alert.same.category.copy" />');
            return false;
          }
          
        }
        if(thisForm.hdnOperation.value == 'merchand_move' && thisForm.hdnTrgCategoryTblPk.value=='-1'){
          alert('<bean:message key="alert.MerchandiseMoveToCategoryOnly" />');
          return false;
        }
        thisForm.submit();
      }
...
<html:form action="/merchandiseCategoryRelayAction.do" >
<html:hidden property="hdnOperation" />
<html:hidden property="hdnSrcMerchandiseTblPk" />
              ...
              <table id="tab" width="100%" border="0" cellpadding="0" cellspacing="0">
                <tr>
                  <td width="44%" height="20px" class="tab">
                    <div align="center">
                      <bean:message key="tab.MerchandiseCategoryList" />
                    </div>
                  </td>
                  <td width="56%" ></td>
                </tr>
              ...
              <table width="90%"  border="0" cellpadding="0" cellspacing="0" align="center">
                <tr>
                  <td>
                    ...
                    <div style="width:100%;" >
                      <!-- Tree View here -->
                      <iframe src="merchandiseRelayAction.do?hdnSearchOperation=merchand_category_tree_view" scrolling="yes" height="100%" width="100%"  frameborder="0"></iframe>
                    </div>
                    </div>
                  </td>
                </tr>
