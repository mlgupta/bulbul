...
<HTML>
<HEAD>  
  <TITLE><bean:message key="title.PricePromotionAdd" /></TITLE>
...
<html:form action="/pricePromotionAddAction" >
  ...
  <tr>
    <td height="505px" class="bgColor_DFE7EC bdrTopColor_333333 bdrLeftColor_333333 bdrBottomColor_333333 bdrRightColor_333333">
      <table width="373px"  border="0" align="center" class="bdrColor_336666">
        <tr>
          <th height="20px" colspan="3"><div align="center"><bean:message key="page.PricePromotionAdd" /></div></th>
        </tr>
        <tr>
          <td colspan="2">&nbsp;</td>
        </tr>
        ...
        <tr>
          ...
          <td>
            <html:text property="txtThresholdQty" styleClass="bdrColor_336666" onkeypress="return integerOnly(event);" maxlength="3" style="width:50px;text-align:right" />
          </td>
        </tr>
        <tr>
