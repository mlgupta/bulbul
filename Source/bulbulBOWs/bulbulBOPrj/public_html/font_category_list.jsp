...
<html>
<head>
  <title><bean:message key="title.FontCategoryList" /></title>
  ...
  <script>
    function btnclick(operation){
      ...
      if ((operation=='ok' ) ){
        ...
        if(thisForm.hdnOperation.value == 'font_move' && thisForm.hdnTrgCategoryTblPk.value=='-1'){
          alert('<bean:message key="alert.FontMoveToCategoryOnly" />');
          return false;
        }
        thisForm.submit();
      }
...
<html:form action="/fontCategoryRelayAction.do" >
<html:hidden property="hdnOperation" />
<html:hidden property="hdnSrcFontTblPk" />
              ...
              <table id="tab" width="100%" border="0" cellpadding="0" cellspacing="0">
                <tr>
                  <td width="44%" height="20px" class="tab">
                    <div align="center">
                      <bean:message key="tab.FontCategoryList" />
                    </div>
                  </td>
                  <td width="56%" ></td>
                </tr>
              ...
              <table width="90%"  border="0" cellpadding="0" cellspacing="0" align="center">
                <tr>
                  <td>
                    ...
                    <div style="width:100%;" >
                      <!-- Tree View here -->
                      <iframe src="fontRelayAction.do?hdnSearchOperation=font_category_tree_view" scrolling="yes" height="100%" width="100%"  frameborder="0"></iframe>
                    </div>
                    </div>
                  </td>
                </tr>
