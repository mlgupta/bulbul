...
<HTML>
  <HEAD>  
    <TITLE><bean:message key="title.UserProfileAdd" /></TITLE>
  ...
  <BODY onload="return getRights(document.forms[0]);">
    <html:form action="/userProfileAddAction">
              ...
              <tr>
                <td>
                  ...
                  <table width="100%" border="0" align="center" >
                    <tr>
                      <th height="20px" colspan="4"><div align="center"><bean:message key="page.UserProfileAdd" /> </div></th>
                    </tr>
                    <tr>
                      <td colspan="4">&nbsp;</td>
                    </tr>
                    <tr>
                      ...
                      <td width="137px">
                        <html:text property="txtUserId" styleClass="bdrColor_336666" style="width:130px" tabindex="1" maxlength="10" />
                      </td>
                    ...
                    <tr>
                      ...
                      <td width="137px">
                          <bean:define id="userCategoryIdLHS1"  name="userProfileForm" property="cboUserCategory" />
                          <bean:define id="userCategoryIdLHS2"  name="userProfileForm" property="hdnUserCategoryId" />
                        <select id="cboUserCategory" name="cboUserCategory" class="bdrColor_336666" style="width:130px" tabindex="5" >
                          ...
                          <bean:define id="userCategoryIdRHS"  name="userCategory" property="id" />
                            <% 
                              if (userCategoryIdLHS1.equals(userCategoryIdRHS)|| userCategoryIdLHS2.equals(userCategoryIdRHS)){
                            %>
